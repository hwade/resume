var Resume=React.createClass({
	...
	render: function(){
		var e={
			backgroundImage: this.props.resume.background_image? "url(link)".replace(
				"link", 
				this.props.resume.background_image
			): ""
		}
	...
	render: function(){
		...
		}, this.props.basicinfo.phone? React.createElement(
				"div", 
				null, 
		...
		}, this.props.basicinfo.email? React.createElement(
				"div", 
				null, 
	...
	render: function(){
		return React.createElement("section", {
				...
				return e.icon?React.createElement(
					"a", 
					{href: e.link, key: e.type+e.link}, 
	...
	render: function(){
		return React.createElement(
			...
			React.createElement("div", {
					...
					return e&&""!=e? React.createElement("div",	{
						...
						}, this.props.experience.name): React.createElement("a", null, this.props.experience.name), 
						this.props.experience.name_link?React.createElement("i", {
						...
						className: "location"
					}, this.props.experience.location? React.createElement(
						"div", 
						null, 
						React.createElement("i", {
		...
		), this.props.experience.description?React.createElement("div", {
